...
void tnew_window::pre_show(CVideo& video, twindow& window)
{
	...
	id_->set_text_changed_callback(boost::bind(&tnew_window::did_id_changed, this, boost::ref(window), _1));
	id_->set_placeholder(tintegrate::generate_format("new id", "gray"));
