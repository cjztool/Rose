...
public:
	 ...
	 * destruction.
	 */
	mkwin_controller(const config &top_config, CVideo& video, const std::map<std::string, std::string>& app_tdomains);
	...
	void app_toggle_report(gui2::twidget& widget) override;
