...
public:
	...
	bool is_scroll() const { return is_listbox() || is_scroll_label() || is_scroll_text_box() || is_scroll_panel() || is_tree_view() || is_report(); }
	...
	bool has_restrict_width() const { return is_label(); }
	bool has_size_is_max() const { return is_scroll(); }
	bool has_drag() const { return widget_.first == "button" || widget_.first == "toggle_panel"; }
	bool has_gc() const { return is_listbox(); }
