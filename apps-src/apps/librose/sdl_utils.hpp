...
// SDL_Texture hasn't refcount member, use boost::shared_ptr.
struct texture: public boost::shared_ptr<SDL_Texture>
{
	texture()
		: boost::shared_ptr<SDL_Texture>()
	{}

	texture(SDL_Texture* tex)
		: boost::shared_ptr<SDL_Texture>(tex, SDL_DestroyTexture)
	{}

	void reset(SDL_Texture* tex) { boost::shared_ptr<SDL_Texture>::reset(tex, SDL_DestroyTexture); }
};
