...
const int default_relative_size = 1000;

// font sizes, to be made theme parameters
extern int CFG_SIZE_SMALLEST;
extern int CFG_SIZE_SMALLER;
extern int CFG_SIZE_SMALL;
extern int CFG_SIZE_DEFAULT;
extern int CFG_SIZE_LARGE;
extern int CFG_SIZE_LARGER;
extern int CFG_SIZE_LARGEST;
...
// using tintegrate
surface get_rendered_text2(const std::string& text, int maximum_width = -1, int font_size = SIZE_DEFAULT, const SDL_Color& color = NORMAL_COLOR, bool editable = false);
tpoint get_rendered_text_size(const std::string& text, int maximum_width = -1, int font_size = SIZE_DEFAULT, const SDL_Color& color = NORMAL_COLOR, bool editable = false);
...
#define font_min_relative_size	(font::default_relative_size - 5)
#define font_max_relative_size	(font::default_relative_size + 5)
#define font_size_from_relative(size)	(font::CFG_SIZE_DEFAULT + (size) - font::default_relative_size)
