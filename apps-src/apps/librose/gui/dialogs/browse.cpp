...
void tbrowse::pre_show(CVideo& /*video*/, twindow& window)
{
	...
	list.set_did_row_changed(boost::bind(&tbrowse::item_selected, this, boost::ref(window), _1));
...
void tbrowse::add_row(twindow& window, tlistbox& list, const std::string& name, bool dir)
{
	...
	list_item["label"] = get_browse_icon(dir);
...
void tbrowse::item_selected(twindow& window, tlistbox& list)
{
