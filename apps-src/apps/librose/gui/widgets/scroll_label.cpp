...
void tscroll_label::mini_place_content_grid(const tpoint& content_origin, const tpoint& content_size, const tpoint& desire_origin)
{
...
bool tscroll_label::mini_content_empty() const
{
	return lbl_->label().empty();
}
