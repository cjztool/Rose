...
public:
	...
	using tscroll_container::finalize_setup;
...
//		{ state_ = active ? ENABLED : DISABLED; }
	...
	void set_select_item(ttree_view_node* node, const bool from_ui = false);

	void set_did_item_changed(const boost::function<void(ttree_view& view, ttree_view_node& node)>& callback)
	{
...
private:
	...
	boost::function<void (ttree_view& view, ttree_view_node& node)> did_item_changed_;
