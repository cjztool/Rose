...
namespace game_config
{
	...
	std::string rose_version = "0.0.0"; // it must be reload during load_config
...
void init(const std::string& _app, const std::string& title, const std::string& channel, bool landscape)
{
	...
	VALIDATE(gui2::twidget::hdpi_scale > 0 && gui2::twidget::hdpi_scale < 5, null_str);
		...
		font::SIZE_SMALLEST = font::CFG_SIZE_SMALLEST * gui2::twidget::hdpi_scale;
		font::SIZE_SMALLER = font::CFG_SIZE_SMALLER * gui2::twidget::hdpi_scale;
		font::SIZE_SMALL = font::CFG_SIZE_SMALL * gui2::twidget::hdpi_scale;
		font::SIZE_DEFAULT = font::CFG_SIZE_DEFAULT * gui2::twidget::hdpi_scale;
		font::SIZE_LARGE = font::CFG_SIZE_LARGE * gui2::twidget::hdpi_scale;
		font::SIZE_LARGER = font::CFG_SIZE_LARGER * gui2::twidget::hdpi_scale;
		font::SIZE_LARGEST = font::CFG_SIZE_LARGEST * gui2::twidget::hdpi_scale;
